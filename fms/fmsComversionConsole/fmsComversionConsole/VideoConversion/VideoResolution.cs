...
namespace fms
{
    ...
    public class VideoResolution
    {
        ...
        {
            return $@"-map ""[v{resolutionIndex}out]"" -c:v:0 libx264 -x264-params ""nal-hrd=cbr:force-cfr=1"" -b:v:0 {BitRate} -maxrate:v:0 {BitRate} -minrate:v:0 {BitRate} -bufsize:v:0 {BitRate} -preset ""{Preset}"" -g {KeyFrame} -sc_threshold 0 -keyint_min {KeyFrame} ";
        }
        ...
        public static Dictionary<string, VideoResolution> VideoResolutions = new Dictionary<string, VideoResolution>()
        {
            ...
            ["960x540"]     = new VideoResolution() { Width = 960,  Height = 540,  Name = "960x540",    BitRate = "1M", Preset = "medium", KeyFrame = 48 },

            ["720p"]        = new VideoResolution() { Width = 1280, Height = 720,  Name = "720p",       BitRate = "1M", Preset = "medium", KeyFrame = 48 },
            ["720x720p"]    = new VideoResolution() { Width = 720,  Height = 720,  Name = "720x720p",   BitRate = "1M", Preset = "medium", KeyFrame = 48 },
            ...
            ["320x240p"]    = new VideoResolution() { Width = 320,  Height = 240,  Name = "320x240p",   BitRate = "1M", Preset = "medium", KeyFrame = 48 },

            ["240x240p"]    = new VideoResolution() { Width = 240,  Height = 240,  Name = "240x240p",   BitRate = "1M", Preset = "medium", KeyFrame = 48 },
        };
